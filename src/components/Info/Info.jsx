  ...
  return (
    <section id="contacts" className={style.info}>
      <div className={style.info__wrap}>
        <h2 className={style.info_title}>Свяжитесь со мной</h2>
        <p className={style.info_text}>Буду рада обсудить ваш проект или сотрудничество</p>

        <div className={style.info_card}>
          <h3 className={style.info_card_title}>Контактная информация</h3>
          ...
          <div className={style.info_socials}>
            <p className={style.info_socials_text}>Социальные сети</p>
